...
class FileUtilitiesTests {
    ...
    void find_sonar_crypto_jar() {
        File file = FileUtilities.findFile("../sonar-crypto-plugin/target", "sonar-crypto-plugin", ".jar");
    ...
    void find_non_existent_fails() {
        ...
        assertThat(logTester.logs(Level.ERROR)).containsExactly("Error while searching for file: non*.existent");
