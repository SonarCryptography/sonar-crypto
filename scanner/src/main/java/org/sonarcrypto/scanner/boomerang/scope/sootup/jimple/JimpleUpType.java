...
public class JimpleUpType implements Type {
  ...
  public JimpleUpType(sootup.core.types.Type delegate, View view) {
  ...
  public boolean isSubtypeOf(String type) {
    ...
    ClassType superType = view.getIdentifierFactory().getClassType(type);
  ...
  public boolean isSupertypeOf(String subTypeStr) {
    ...
    ClassType superType = view.getIdentifierFactory().getClassType(subTypeStr);
