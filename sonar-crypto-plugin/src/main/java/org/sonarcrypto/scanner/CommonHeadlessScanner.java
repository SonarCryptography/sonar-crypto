...
public class CommonJavaScanner extends CryptoScanner {

    private static final Logger LOGGER = LoggerFactory.getLogger(CommonJavaScanner.class);

    private final ScannerSettings settings;

    public CommonJavaScanner(String applicationPath, String rulesetDirectory) {
    ...
    private CommonJavaScanner(ScannerSettings settings) {
        this.settings = settings;
    }

    public static CommonJavaScanner createFromCLISettings(String[] args)
        ...
        return new CommonJavaScanner(scannerSettings);
    }
