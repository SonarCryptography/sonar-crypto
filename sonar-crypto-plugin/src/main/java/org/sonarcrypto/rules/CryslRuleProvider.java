...
public class CryslRuleProvider {
    private static URL ruleDistribution;
    static {
        try {
            ruleDistribution = new URL("https://github.com/CROSSINGTUD/Crypto-API-Rules/archive/refs/heads/master.zip");
     ...
     */
    public static Path extractCryslFilesToTempDir(Predicate<String> filter) throws IOException {
        ...
        System.out.println("Extracted " + count + " CrySL files to " + tempDir.toAbsolutePath());
        return tempDir;
    }
}
