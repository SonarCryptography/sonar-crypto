...
class MavenProjectTest {
  ...
  void mavenProjectErr1Test() throws Exception {
    final var mavenProject = new MavenProject(MAVEN_PROJECT_PATH);
    assertThrows(IllegalStateException.class, mavenProject::getBuildDirectory);
  }

  @Test
  void mavenProjectErr2Test() throws Exception {
    final var mavenProject = new MavenProject(MAVEN_PROJECT_PATH);
    assertThrows(IllegalStateException.class, mavenProject::getJimpleDirectory);
  }

  @Test
  void mavenProjectErr3Test() throws Exception {
    final var mavenProject = new MavenProject(MAVEN_PROJECT_PATH);
    assertThrows(IllegalStateException.class, mavenProject::getFullClassPath);
  }

  @Test
  void mavenProjectErr4Test() {
    assertThrows(FileNotFoundException.class, () -> new MavenProject("a_non_existing_folder"));
  }
}
